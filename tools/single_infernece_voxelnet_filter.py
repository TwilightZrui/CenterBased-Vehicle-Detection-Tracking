#注释了from det3d import __version__，因为报错找不到
#把from det3d import  torchie，version__分开写了，因为要注释上者
#改了model_path = './models/last.pth'
#改了config_path
#添加了数据集中发布的topic
...
def remove_low_score_nu(image_anno, thresh):
    ...
    car_indices =                  get_annotations_indices(0, 0.40, label_preds_, scores_)
...
def new_func():
    model_path = './models/VoxelNet_Detection_centerpoint_voxel_1440.pth'
...
if __name__ == "__main__":
    ...
    global proc
    ## CenterPoint
    config_path = './configs/nusc/voxelnet/nusc_centerpoint_voxelnet_0075voxel_fix_bn_z.py'
  #  model_path = new_func()
    model_path = './models/VoxelNet_Detection_centerpoint_voxel_1440.pth'
    ...
    sub_lidar_topic = [ "/lidar_center/velodyne_points",
                        "/output",
                        "/velodyne_points", 
                        "/top/rslidar_points",
                        "/points_raw", 
