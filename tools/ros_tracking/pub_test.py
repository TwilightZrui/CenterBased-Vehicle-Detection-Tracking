...
import copy
import argparse
from pub_tracker import PubTracker as Tracker # pub_tracker.py
from nuscenes import NuScenes # NuScenes.py
import json 
from nuscenes.utils import splits
# python tools/nusc_tracking/pub_test.py --work_dir WORK_DIR_PATH  --checkpoint DETECTION_PATH  
# python tools/ros_tracking/pub_test.py --work_dir ./track_work_dir --checkpoint ./track_work_dir/voxelnet_converted.pth
def parse_args():
    ...
    parser.add_argument("--max_age", type=int, default=3) #max_age?
...
def main():
    ...
    tracker = Tracker(max_age=args.max_age, hungarian=args.hungarian) #  pub_tracker.py
...
def eval(res_path, eval_set="mini_val", output_dir=None, root_path=None):
